...
1. **Read the bar:** open `_STANDARD.md` and the exemplar `architect.md` in your tool's agents dir (`.claude/agents/`, `.opencode/agent/`, …) for tone, depth and rigor. Your output must match that care.
